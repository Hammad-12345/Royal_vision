      ...
      <div className=" mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2 font-poppins p-8 rounded-lg shadow-lg bg-white/10 backdrop-blur-sm border border-white/20">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-900 text-white py-3 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200 shadow-lg hover:shadow-xl"
            >
              Send Message
            </button>
          </form>
          ...
          {quicksupport.map((quick) => (
            <>
              <div className="text-white border border-white px-6 rounded space-y-4 h-48 flex flex-col justify-center">
                <h1 className="text-3xl flex items-center space-x-4">{quick.icon} <div>{quick.title}</div></h1>
