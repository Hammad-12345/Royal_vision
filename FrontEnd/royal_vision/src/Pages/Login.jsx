...
const Login = () => {
  ...
  const onLoginSubmit = async (data) => {
    try {
      const response = await fetch("https://api.overlandsolutions.net/auth/login", {
        method: "POST",
  ...
  const onOTPSubmit = async (data) => {
    ...
    try {
      const response = await fetch("https://api.overlandsolutions.net/auth/otp", {
        method: "POST",
        headers: {
  ...
  const onResetSubmit = async (data) => {
    ...
    try {
      const response = await fetch("https://api.overlandsolutions.net/auth/newpassword", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
