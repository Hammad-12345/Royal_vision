...
const Login = () => {
  ...
  const onLoginSubmit = async (data) => {
    try {
      const response = await fetch("http://overlandsolutions-env.eba-32k3gqpk.eu-north-1.elasticbeanstalk.com/auth/login", {
        method: "POST",
  ...
  const onOTPSubmit = async (data) => {
    ...
    try {
      const response = await fetch("http://overlandsolutions-env.eba-32k3gqpk.eu-north-1.elasticbeanstalk.com/auth/otp", {
        method: "POST",
        headers: {
  ...
  const onResetSubmit = async (data) => {
    ...
    try {
      const response = await fetch("http://overlandsolutions-env.eba-32k3gqpk.eu-north-1.elasticbeanstalk.com/auth/newpassword", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
