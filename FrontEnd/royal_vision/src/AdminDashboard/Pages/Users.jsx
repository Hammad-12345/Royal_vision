...
const Users = () => {
  ...
  const handleDeleteUser = async (userId) => {
    if (window.confirm('Are you sure you want to delete this user?')) {
      ...
      try {
        const response = await fetch(`https://overland-23a4680d9e06.herokuapp.com/api/admin/deleteuser/${userId}`, {
          method: 'DELETE',
        });
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch('https://overland-23a4680d9e06.herokuapp.com/api/admin/users');
