...
import { FaBell, FaCheck, FaSpinner, FaMoneyCheckAlt, FaChartLine, FaWallet, FaUserPlus } from 'react-icons/fa'
...
const Notifications = () => {
    ...
    const fetchNotifications = async () => {
        try {
            const response = await fetch("https://overlandbackendnew-d897dd9d7fdc.herokuapp.com/api/admin/notifications");
    ...
    const markAsRead = async (notification) => {
        try {
            const response = await fetch(`https://overlandbackendnew-d897dd9d7fdc.herokuapp.com/api/admin/notifications/${notification._id}/read`, {
                method: "PUT",
            });
            if (!response.ok) {
    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center h-screen">
                <div className="text-red-500 text-xl mb-4">Error loading notifications</div>
                <button 
